                    ...
                    <div class="card-header ">
                        <div class="row">
                            ...
                            <div class="col d-flex justify-content-end">
                                <h4 class="card-title font-weight-normal">Edit Point</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body mx-5">
                        {{-- {{ route('admin.matkul.store') }} --}}
                        <form method="POST" action="{{ route('admin.point.update', $item->id) }}" enctype="multipart/form-data" id="form">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror"  id="nama" name="nama" value="{{ old('nama') ? old('nama') : $item->nama }}" required>
                                        @error('nama')
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('req_point') is-invalid @enderror" id="req_point" name="req_point" value="{{ old('req_point') ? old('req_point') : $item->req_point }}" required>
                                        @error('req_point')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="description form-control @error('detail') is-invalid @enderror" name="detail" id="detail" rows="15" required>{{ old('detail') ? old('detail') : $item->detail }}</textarea>
                                @error('detail')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="img_point" name="img_point">
                              </div>
                            <div class="btn-bap text-right">
                                <button type="submit" class="btn btn-success">Ubah Point</button>
                            </div>
                        </form>
                    </div>
                </div>
