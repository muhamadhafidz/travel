            ...
            <div class="col-md-12">
                <div class="card strpied-tabled-with-hover">
                    <div class="card-header ">
                        <div class="row">
                            ...
                            <div class="col d-flex justify-content-end">
                                <h4 class="card-title font-weight-normal">Edit Gallery Baru</h4>
                            </div>
                        </div>
                    </div>
                    @if ($errors->any())
                    ...
                    <div class="card-body mx-5">
                        <form method="POST" action="{{ route('admin.gallery.update', $data->id) }}" enctype="multipart/form-data" id="form">
                            @csrf
                            @method('PUT')
